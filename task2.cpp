/*К участию в киберспортивном турнире допускаются люди, 
достигшие 16 лет. Необходимо удалить из списка участников тех, 
кто младше 16, и вывести имя и возраст 
самого(ых) молодого(ых) участника(ов) и с
амого(ых) старшего(их).*/
