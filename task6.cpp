/*Есть несколько векторов со списком слов, начинающихся с «а». 
Необходимо оставить уникальные слова и убрать те, 
что начинаются с других букв, отсортировать конечный список 
